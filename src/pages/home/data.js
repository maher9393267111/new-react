...
title: 'Istanbul E-pass includes a Topkapi Palace Museum entrance ticket with an Audio guide. Simply scan your QR code at the entrance and get in. The audio guide is available; in English, Russian, Spanish, Arabic, German, French, Italian, Portuguese, Dutch, Japanese, Persian, Chinese, and Korean.',
price : '20',
mainImage: 'https://muzeler.org/images/google-place-images/topkapi-sarayi-muzesi.jpg',
images: [
...
desc:'The location of palace is in the Sultanahmet area. The historical city center of Istanbul is convenient to excess with public transportation., From Taksim Area: Get the funicular from the Taksim Square to Kabatas. From Kabatas take the T1 tram to Sultanahmet station. From the tram station to the palace is just 5 minutes walk. ,  From Sultanahmet Area: It is within walking distance of the majority of the hotels in the area.  ',
    ...
    {
submain:'How long does it take to visit the Palace and what is the best time?',
...
desc : 'You can visit the palace within 1 hour time if you go on your own. Guided tours are typically around 2-3 hours. There are lots of exhibition halls in the palace. In the majority of the rooms taking pictures or speaking is forbidden. It may be busy depending on the time of the day. The best time to visit the palace would be early morning. Around 9-10 am would be a quiet time in the place.',
...

    {
        ...
        title:'Istanbul E-pass includes Galata Tower Entrance Ticket. Simply scan your QR code at the entrance and get in.',

        price : '10',
        tags:'walk in',
        mainImage: 'https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/27/56/8c.jpg',
...

{
    ...
    price : '',
    tags:'',
    mainImage: 'https://cdni0.trtworld.com/w960/h540/q75/52564_118_1553726376060.jpg',
...

{
    ...
    price : '',
    tags:'',
    mainImage: 'https://www.bosphorustour.com/tour-image/istanbul-bosphorus-dinner-cruise-and-turkish-night-show-1.jpg',
...

{
    ...
    price : '',
    tags:'',
    mainImage: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/Dolmabah%C3%A7e_Palace_%28cropped%29.JPG',
...

{
    ...
    price : '',
    tags:'',
    mainImage: 'https://istanbultourstudio.s3.amazonaws.com/uploads/media_content/picture/54/medium_topkapi_palace_main_entrance_istanbul_.jpg' ,
